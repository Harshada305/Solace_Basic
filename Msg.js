...
const channel = 'QMAX1.TO.QMAX3'; // Your sender channel
const host = 'localhost'; // Your IBM MQ host
const port = '5000'; // Your IBM MQ port (default for TCP)
const mqUser = 'mqmadmin'; // Use the new user
const mqPassword = 'Password@123'; // Password for the new user
